...
S3_ENDPOINT = f"https://.supabase.co/storage/v1/s3"
CATALOG_URI = f"https://.supabase.co/storage/v1/iceberg"
...
spark.sql("""
    ...
    VALUES
        (1, 101, 'login', TIMESTAMP '2024-01-15 10:30:00', ''),
        (2, 102, 'view_product', TIMESTAMP '2024-01-15 10:35:00', ''),
        (3, 101, 'logout', TIMESTAMP '2024-01-15 10:40:00', ''),
        (4, 103, 'purchase', TIMESTAMP '2024-01-15 10:45:00', '')
""")
