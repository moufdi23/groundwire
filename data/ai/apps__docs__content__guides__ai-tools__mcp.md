...
Parameters can be combined: <code>remote?project_ref=abc123&read_only=true</code>

When using [Supabase CLI](/docs/guides/local-development) for local development, the MCP server is available at <code>local</code>.
